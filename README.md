# Implmenting kv cache in nanoGPT

Implemented kv caching and tested the implemetation for smaller `shakespeare` and `shakespeare-char` models. Model was trained as follows (for more details refer to Section [nanoGPT](#nanogpt)):
```
